...
export const ScheduleTable = ({ weekStart, lessons, today }: ScheduleTableProps) => {
  const table = buildScheduleWeekTable(weekStart, lessons);
        ...
        <thead>
          <tr>
            ...
            {table.days.map((day, index) => (
              ...
              >
                <span className="block lowercase">{WEEKDAYS_FULL[index]}</span>
